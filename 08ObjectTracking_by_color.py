...
huelow, huehigh = 18, 32
satlow, sathigh = 83, 210
vallow, valhigh = 136, 255
...
cv2.createTrackbar('Hue Low', 'MyTrackbar', 18, 179, onTrack1)
cv2.createTrackbar('Hue High', 'MyTrackbar', 32, 179, onTrack2)
cv2.createTrackbar('Sat Low', 'MyTrackbar', 83, 255, onTrack3)
cv2.createTrackbar('Sat High', 'MyTrackbar', 210, 255, onTrack4)
cv2.createTrackbar('Val Low', 'MyTrackbar', 136, 255, onTrack5)
cv2.createTrackbar('Val High', 'MyTrackbar', 255, 255, onTrack6)
...
while True:
    ...
    myMask_small=cv2.resize(myMask,(320,180))
    ...
    myObject_small=cv2.resize(myObject,(320,180))
